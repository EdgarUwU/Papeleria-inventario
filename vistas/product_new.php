		...
		<div class="columns">
			<div class="column">
				<div class="control">
					<label>Codigo</label>
					<span>*</span>
					<input class="input" type="text" name="producto_codigo" pattern="[0-9.]{1,25}" maxlength="25" required>
				</div>
			</div>
			<div class="column">
				<div class="control">
		...
		<div class="columns">
			...
			<div class="column">
				<div class="control">
					...
					<span>*</span>
					<textarea class="textarea" name="producto_presentacion" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,500}" maxlength="500" required></textarea>
				</div>
			</div>
			<div class="column">
