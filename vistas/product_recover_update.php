<div class="container is-fluid mb-6 pt-2">
	...
	<h2 class="subtitle">Recuperar producto</h2>
</div>
...
<div class="container pb-2 pt-2">
	<?php
    	...
    	$check_producto=$check_producto->query("SELECT * FROM productos a INNER JOIN inventario b ON a.id_prod=b.id_prod WHERE a.id_prod='$id'");
	...
	<form action="./php/producto_recover_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >

		<input type="hidden" name="id_producto" value="<?php echo $id; ?>" required >
